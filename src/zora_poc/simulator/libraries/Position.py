...
def get(self, owner, tickLower, tickUpper):
    checkInputTypes(account=owner, int24=(tickLower, tickUpper))  # noqa: F405
...
def assertPositionExists(self, owner, tickLower, tickUpper):
    checkInputTypes(account=owner, int24=(tickLower, tickLower))  # noqa: F405
...
def update(self, liquidityDelta, feeGrowthInside0X128, feeGrowthInside1X128):
    ...
    tokensOwed0 = FullMath.mulDiv(
        toUint256(feeGrowthInside0X128 - self.feeGrowthInside0LastX128),  # noqa: F405
        self.liquidity,
        FixedPoint128_Q128,  # noqa: F405
    )
    tokensOwed1 = FullMath.mulDiv(
        toUint256(feeGrowthInside1X128 - self.feeGrowthInside1LastX128),  # noqa: F405
        self.liquidity,
        FixedPoint128_Q128,  # noqa: F405
    )
    ...
    if tokensOwed0 > MAX_UINT128:  # noqa: F405
        tokensOwed0 = tokensOwed0 & (2**128 - 1)
    if tokensOwed1 > MAX_UINT128:  # noqa: F405
